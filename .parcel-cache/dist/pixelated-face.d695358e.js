...
})({"9ac213126dda7d0ede185946086abaaf":[function(require,module,exports) {
...
const SIZE = 10;
const SCALE = 2; // write a function that will populate the users video
...
function censor({
  ...
  faceCtx.clearRect(0, 0, faceCanvas.width, faceCanvas.height); // draw the smal face

  faceCtx.drawImage( // 5 source arg
  ...
  face.x - (width - face.width) / 2, face.y - (height - face.height) / 2, SIZE, SIZE, //drawing args
...
},{}]},{},["13ce80ed9a2051f997528b96cdd8e3d2","9ac213126dda7d0ede185946086abaaf"], null)

//# sourceMappingURL=pixelated-face.d695358e.js.map
